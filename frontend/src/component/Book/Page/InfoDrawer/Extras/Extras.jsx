...
const Extras = observer((props) => {
  const [valueRadioTabsType, setValueRadioTabsType] = useState(
    props.bass ? "b" : props.piano ? "p" : "g"
  );
  ...
  return (
    <div>
      <div className="Extras__radioType">
        <Radio.Group
          onChange={onRadioChangeTabsType}
          value={valueRadioTabsType}
        >
      ...
      <div className="Extras__radioType">
        <Radio.Group
          onChange={onRadioChangeTabsLevel}
          value={valueRadioTabsLevel}
        >
